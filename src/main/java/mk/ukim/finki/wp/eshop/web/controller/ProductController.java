...
public class ProductController {
    ...
    public ProductController(ProductService productService, CategoryService categoryService, ManufacturerService manufacturerService, ShoppingCartService shoppingCartService) {
    ...
    public String deleteProduct(@PathVariable Long id) {
        List<ShoppingCart> shoppingCarts = this.shoppingCartService.listAllShoppingCarts();
        shoppingCarts.stream().forEach(sh -> sh.getProducts().removeIf(p-> p.getId().equals(id)));
